...
![图 1-14 3 种常见的窗口形式](./img/three-type-window.png)
...
#### (1) Event Time 和 Processing Time
...
![图 1-15 数据传输过程恰好遇到信号丢失](./img/signal.png)
...
![图 1-16 无状态计算和有状态计算](./img/state-stateless.png)
